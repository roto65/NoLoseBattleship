...
std::vector<std::string> matchActions; //tiene conto delle azioni per il replay
...
void gameLoop (T& p1, U& p2) {
    int turn = randomNum(1);//scelta casuale di chi inizia a giocare per primo
    int turnCounter = 1;
